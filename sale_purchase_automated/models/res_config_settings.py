...
class ResConfigSettings(models.TransientModel):
    ...
    automate_confirm_delivery = fields.Boolean(
        'Confirm Deliver', default=False, help="Confirm Delivery for sales order")
    ...
    def get_values(self):
        ...
        res.update(
            automate_confirm_delivery=self.env['ir.config_parameter'].sudo().get_param(
                'automate_confirm_delivery'),
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param(
            'automate_confirm_delivery', self.automate_confirm_delivery)
